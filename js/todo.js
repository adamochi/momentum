...
//const toSoInput = document.querySelector("#todo-form input"); same^^
...
// parsedToDos.forEach((item) => console.log("lalala", item);
// this line ^^ is same as making a function as above for sayHello
